...
public class GpsPointsService {
    ...
    @Autowired
    public GpsPointsService(GpsPointsRepository gpsPointsRepository, GpsPointMapper gpsPointMapper, EnterpriseRepository enterpriseRepository) {
     ...
     * @param start     Начало интервала (UTC)/Начало интервала в локальном времени предприятия (ISO_LOCAL_DATE_TIME)
     * @param end       Конец интервала (UTC)/Конец интервала в локальном времени предприятия (ISO_LOCAL_DATE_TIME)
     *                  потом переводим к UTC:
