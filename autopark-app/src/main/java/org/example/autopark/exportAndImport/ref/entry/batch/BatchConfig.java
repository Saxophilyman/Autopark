...
import org.example.autopark.exportAndImport.ref.application.byGuid.ImportVehicleByGuidService;
...
public class BatchConfig {
    ...
    private final ImportVehicleByIdService importServiceById;
    private final ImportVehicleByGuidService importServiceByGuid;
    ...
    public ItemWriter<VehicleExportDtoById> writerById() {
        return items -> {
            for (VehicleExportDtoById dto : items) {
                importServiceById.executeSystem(dto);
            }
        };
    }
    ...
    public ItemWriter<VehicleExportDtoByGuid> writerByGuid() {
        return items -> {
            for (VehicleExportDtoByGuid dto : items) {
                importServiceByGuid.executeSystem(dto);
            }
        };
    }
